  ...
  return (
    <div className="card group overflow-hidden hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="relative overflow-hidden aspect-video bg-gray-100 dark:bg-gray-800">
        ...
        {onWishlist && (
          <button
            onClick={(e) => { e.preventDefault(); e.stopPropagation(); onWishlist(course._id); }}
        ...
        {/* Free badge */}
        {course.price === 0 && (
          <div className="absolute top-2 left-2"><span className="badge-green text-xs">Free</span></div>
        )}
      </div>
