...
`;
    ...
    await sendEmail({
      ...
      html: `<p style="font-family:sans-serif;line-height:1.6">
        ...
        Click the link below to reset your password. This link expires in <strong>10 minutes</strong>.<br/><br/>
        <a href="${resetUrl}" style="background:#111;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block">
          Reset Password
        </a><br/><br/>
